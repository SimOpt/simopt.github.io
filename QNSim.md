...
In this case, the customer will join the end of the queue (if any) of this station with the first customer in queue move into the vacated server simultaneously.
